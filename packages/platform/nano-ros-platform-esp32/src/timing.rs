...
//! `esp_hal::time::Instant` for microsecond-resolution timing,
//! returning elapsed microseconds as a u32 cycle-count proxy.
//!
//! # Example
//!
//! ```ignore
//! use nano_ros_platform_esp32::CycleCounter;
//!
//! let (result, micros) = CycleCounter::measure(|| {
//!     // operation to benchmark
//! });
//! esp_println::println!("Took {} us", micros);
//! ```
