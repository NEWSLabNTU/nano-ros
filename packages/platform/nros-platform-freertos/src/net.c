 ...
 *     one-element addrinfo out of `nros_platform_alloc` — `pvPortMalloc`,
 *     the FreeRTOS heap (this used to be libc `malloc`/`calloc`, a third
 *     heap again; RFC-0034 D6 says the funnel).
 *
