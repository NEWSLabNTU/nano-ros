...
// phase-345 W8.c / issue 0496 — this is the ONE `#[global_allocator]` in the
...
mod global_allocator {
    ...
    unsafe impl GlobalAlloc for PlatformGlobalAllocator {
        unsafe fn alloc(&self, layout: Layout) -> *mut u8 {
            // phase-345 W8.c — an over-aligned request FAILS rather than
...
// phase-345 W8.c — the Rust-footprint heap counter, moved here with the
