...
pub const EMPTY_VTABLE: NrosRmwVtable = NrosRmwVtable {
    ...
    subscription_set_content_filter: None,
    subscription_get_content_filter: None,
    publisher_get_network_flow_endpoints: None,
    subscription_get_network_flow_endpoints: None,
