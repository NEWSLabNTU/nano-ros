...
mod tests {
    ...
    impl nros_serdes::Serialize for MockRequest {
        fn serialize(
            &self,
            _writer: &mut nros_serdes::CdrWriter,
        ) -> Result<(), nros_serdes::SerError> {
            Ok(())
        }
    }

    impl nros_serdes::Deserialize for MockRequest {
        fn deserialize(
            _reader: &mut nros_serdes::CdrReader,
        ) -> Result<Self, nros_serdes::DeserError> {
    ...
    impl nros_serdes::Serialize for MockReply {
        fn serialize(
            &self,
            _writer: &mut nros_serdes::CdrWriter,
        ) -> Result<(), nros_serdes::SerError> {
    ...
    impl nros_serdes::Deserialize for MockReply {
        fn deserialize(
            _reader: &mut nros_serdes::CdrReader,
        ) -> Result<Self, nros_serdes::DeserError> {
            Ok(MockReply { sum: 0 })
