...
static inline nros_node_options_t nros_node_options(const char* name) {
    nros_node_options_t options;
    options.name = name;
    options.namespace_ = "/";
    options.domain_id = 0;
    return options;
