...
fn generate_config(
    ...
    // `include_str!` makes cargo rebuild when the template changes.
    let contents = include_str!("templates/nros_c_config.rs.template")
    ...
    let c_header = include_str!("templates/nros_config_generated.h.template")
        .replace(
    ...
    let exact_header = include_str!("templates/nros_config_generated_exact.h.template")
        .replace(
