...
static A_VTABLE: NrosRmwVtable = NrosRmwVtable {
    ...
    close: noop_close,
    drive_io: a_drive_io,
    create_publisher: a_create_publisher,
    destroy_publisher: noop_destroy_pub,
    publish_raw: a_publish_raw,
    create_subscriber: noop_create_sub,
    destroy_subscriber: noop_destroy_sub,
    try_recv_raw: noop_try_recv_raw,
    has_data: noop_has_data,
    create_service_server: noop_create_srv,
    destroy_service_server: noop_destroy_srv,
    try_recv_request: noop_try_recv_req,
    has_request: noop_has_request,
    send_reply: noop_send_reply,
    create_service_client: noop_create_client,
    destroy_service_client: noop_destroy_client,
    call_raw: noop_call_raw,
    send_request_raw: None,
    try_recv_reply_raw: None,
    register_subscriber_event: noop_reg_sub_event,
...
static B_VTABLE: NrosRmwVtable = NrosRmwVtable {
    ...
    close: noop_close,
    drive_io: b_drive_io,
    create_publisher: b_create_publisher,
    destroy_publisher: noop_destroy_pub,
    publish_raw: b_publish_raw,
    create_subscriber: noop_create_sub,
    destroy_subscriber: noop_destroy_sub,
    try_recv_raw: noop_try_recv_raw,
    has_data: noop_has_data,
