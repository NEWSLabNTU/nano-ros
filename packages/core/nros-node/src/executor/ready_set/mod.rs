...
// Phase 110.F — opt-in PiCAS-style per-callback OS priority. Stub
// only; real dispatch lives outside the ReadySet abstraction
// (worker-thread pool keyed by os_pri). See `os_priority` module
// docs.
