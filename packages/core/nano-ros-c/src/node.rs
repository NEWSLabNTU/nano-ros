...
pub enum nano_ros_node_state_t {
    /// Not initialized
...
#[repr(C)]
pub struct nano_ros_node_t {
    /// Current state
    pub state: nano_ros_node_state_t,
    /// Node name storage
...
impl Default for nano_ros_node_t {
    fn default() -> Self {
        Self {
            state: nano_ros_node_state_t::NANO_ROS_NODE_STATE_UNINITIALIZED,
...
pub unsafe extern "C" fn nano_ros_node_init(
    ...
    if node.state != nano_ros_node_state_t::NANO_ROS_NODE_STATE_UNINITIALIZED {
    ...
    node.state = nano_ros_node_state_t::NANO_ROS_NODE_STATE_INITIALIZED;
...
pub unsafe extern "C" fn nano_ros_node_fini(node: *mut nano_ros_node_t) -> nano_ros_ret_t {
    ...
    if node.state != nano_ros_node_state_t::NANO_ROS_NODE_STATE_INITIALIZED {
        return NANO_ROS_RET_NOT_INIT;
    }
    ...
    node.state = nano_ros_node_state_t::NANO_ROS_NODE_STATE_SHUTDOWN;
