...
impl RosMessage for Float32MultiArray {
    const TYPE_NAME: &'static str = "example_interfaces::msg::dds_::Float32MultiArray_";
...
#[allow(non_upper_case_globals)]
pub const FT_DATA_ELEM: ::nros_serdes::FieldType = ::nros_serdes::FieldType::Float32;
impl ::nros_serdes::Message for Float32MultiArray {
    const TYPE_NAME: &'static str = "example_interfaces/msg/Float32MultiArray";
    const FIELDS: &'static [::nros_serdes::Field] = &[
        ::nros_serdes::Field {
            name: "layout",
            ty: ::nros_serdes::FieldType::Nested(&NESTED_LAYOUT),
            offset: ::core::mem::offset_of!(Float32MultiArray, layout),
        },
        ::nros_serdes::Field {
            name: "data",
            ty: ::nros_serdes::FieldType::Sequence(&FT_DATA_ELEM),
            offset: ::core::mem::offset_of!(Float32MultiArray, data),
        },
];
}