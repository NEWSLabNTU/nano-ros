...
//! block the executor.
//!
//! Run with: `cargo nextest run -p nros-tests --test c_service_roundtrip_xprocess_e2e`

use nros_tests::fixtures::{
    ManagedProcess, ZenohRouter, build_native_workspace_c_service_client_entry,
    build_native_workspace_c_service_server_entry, require_zenohd,
};
use std::{process::Command, time::Duration};

const SERVICE_PORT: u16 = 17871;

#[test]
fn c_service_roundtrip_delivers_cross_process() {
    if !require_zenohd() {
