...
fn corpus() -> Vec<Row> {
    vec![
        ...
        entry!(nros_rosgraph_msgs::msg::Clock),
        entry!(nros_std_msgs::msg::Bool),
        entry!(nros_std_msgs::msg::Byte),
        entry!(nros_std_msgs::msg::ByteMultiArray),
        entry!(nros_std_msgs::msg::Char),
        entry!(nros_std_msgs::msg::ColorRGBA),
        entry!(nros_std_msgs::msg::Empty),
        entry!(nros_std_msgs::msg::Float32),
        entry!(nros_std_msgs::msg::Float32MultiArray),
        entry!(nros_std_msgs::msg::Float64),
        entry!(nros_std_msgs::msg::Float64MultiArray),
        entry!(nros_std_msgs::msg::Header),
        entry!(nros_std_msgs::msg::Int16),
        entry!(nros_std_msgs::msg::Int16MultiArray),
        entry!(nros_std_msgs::msg::Int32),
        entry!(nros_std_msgs::msg::Int32MultiArray),
        entry!(nros_std_msgs::msg::Int64),
        entry!(nros_std_msgs::msg::Int64MultiArray),
        entry!(nros_std_msgs::msg::Int8),
        entry!(nros_std_msgs::msg::Int8MultiArray),
        entry!(nros_std_msgs::msg::MultiArrayDimension),
        entry!(nros_std_msgs::msg::MultiArrayLayout),
        entry!(nros_std_msgs::msg::String),
        entry!(nros_std_msgs::msg::UInt16),
        entry!(nros_std_msgs::msg::UInt16MultiArray),
        entry!(nros_std_msgs::msg::UInt32),
        entry!(nros_std_msgs::msg::UInt32MultiArray),
        entry!(nros_std_msgs::msg::UInt64),
        entry!(nros_std_msgs::msg::UInt64MultiArray),
        entry!(nros_std_msgs::msg::UInt8),
        entry!(nros_std_msgs::msg::UInt8MultiArray),
    ]
}
