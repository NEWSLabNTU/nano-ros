//! Phase 212.M.7 — `examples/esp32/rust/listener/` builds via `idf.py`.
//!
//! See sibling `phase212_m7_esp32_talker.rs` for the staging +
//! `idf.py` invocation pattern.
...
#[test]
fn esp32_listener_builds_via_idf_py() {
    run_idf_build("examples/esp32/rust/listener", "esp32_bsp_listener");
}
