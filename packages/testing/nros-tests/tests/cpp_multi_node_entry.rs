...
fn multi_node_workspace_cpp_typed_pubsub_e2e(
    ...
    let received = count_pattern(&out, nros_tests::output::INT32_LISTENER_LOG_PREFIX);
...
// for `cpp_multi_node_entry`; drift turns this RED. Needs no fixtures — runs in tier 1.
#[test]
