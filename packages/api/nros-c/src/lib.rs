...
//
// phase-345 W8.c — the counter itself moved to `nros-platform` with the
...
// C-side `z_malloc` share one funnel and one arena. What changed in phase-345
...
// phase-345 W8.b / issue 0496 — gated on `panic-spin`, NOT on
