...
pub use bridge::{
    ...
    SmoltcpBridge, clear_idle_callback, do_poll, has_poll_callback, poll_count, poll_diagnostics,
    rx_diagnostics, seed_ephemeral_port, set_idle_callback, set_poll_callback,
};
