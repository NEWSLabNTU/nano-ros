...
impl RosMessage for Int64MultiArray {
    const TYPE_NAME: &'static str = "std_msgs::msg::dds_::Int64MultiArray_";
...
#[allow(non_upper_case_globals)]
pub const FT_DATA_ELEM: ::nros_serdes::FieldType = ::nros_serdes::FieldType::Int64;
impl ::nros_serdes::Message for Int64MultiArray {
    const TYPE_NAME: &'static str = "std_msgs/msg/Int64MultiArray";
    const FIELDS: &'static [::nros_serdes::Field] = &[
        ::nros_serdes::Field {
            name: "layout",
            ty: ::nros_serdes::FieldType::Nested(&NESTED_LAYOUT),
            offset: ::core::mem::offset_of!(Int64MultiArray, layout),
        },
        ::nros_serdes::Field {
            name: "data",
            ty: ::nros_serdes::FieldType::Sequence(&FT_DATA_ELEM),
            offset: ::core::mem::offset_of!(Int64MultiArray, data),
        },
];
}