...
pub struct DiagnosticArray {
    pub header: nros_std_msgs::msg::Header,
...
pub const NESTED_HEADER: ::nros_serdes::NestedType = ::nros_serdes::NestedType {
    type_name: <nros_std_msgs::msg::Header as ::nros_serdes::Message>::TYPE_NAME,
    fields: <nros_std_msgs::msg::Header as ::nros_serdes::Message>::FIELDS,
};
#[allow(non_upper_case_globals)]
