//! nros platform implementation for ESP32-C3 QEMU bare-metal.
//!
...
impl nros_platform_api::PlatformYield for Esp32QemuPlatform {
    #[inline]
    fn yield_now() {
        core::hint::spin_loop();
    }
...
impl nros_platform_api::PlatformAlloc for Esp32QemuPlatform {
    #[inline]
...
impl nros_platform_api::PlatformSleep for Esp32QemuPlatform {
    #[inline]
...
impl nros_platform_api::PlatformRandom for Esp32QemuPlatform {
    #[inline]
    fn random_u8() -> u8 {
        random::random_u8()
    }
...
impl nros_platform_api::PlatformThreading for Esp32QemuPlatform {
    fn task_init(
