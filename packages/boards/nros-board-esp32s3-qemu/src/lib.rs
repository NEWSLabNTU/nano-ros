//! # nros-board-esp32s3-qemu
//!
//! Board crate for running nros on ESP32-S3 in QEMU
...
pub use nros_platform_esp32s3_qemu;

// Re-export main types
pub use config::Config;
pub use node::{init_hardware, run};
pub use nros_platform::BoardConfig;
pub use nros_platform_esp32s3_qemu::timing::MonotonicClock;

// Re-export portable-atomic for safe atomics on xtensa-esp32s3-none-elf (no hardware atomic support).
// ESP32-S3 is single-core, so portable-atomic uses compiler fences.
...
///
/// Use with: `use nros_board_esp32s3_qemu::prelude::*;`
pub mod prelude {
