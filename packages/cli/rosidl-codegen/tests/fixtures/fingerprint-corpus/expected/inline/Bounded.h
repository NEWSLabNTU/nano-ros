...
/// (fingerprint_corpus_msg_bounded*)0` below. The FFI parameter is `void *`, which accepts
...
/// fingerprint_corpus_msg_bounded-shaped message over whatever is really there -- the one
...
#define fingerprint_corpus_msg_bounded_executor_add_subscription_sized(executor, subscription, msg, cb, ctx, \
    ...
    nros_executor_add_subscription_typed_sized( \
        (executor), (subscription), (1 ? (msg) : (fingerprint_corpus_msg_bounded*)0), \
        fingerprint_corpus_msg_bounded_deserialize_erased, (cb), (ctx), \
