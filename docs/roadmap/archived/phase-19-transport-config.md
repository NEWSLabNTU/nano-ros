...
| `packages/transport/nano-ros-transport-zenoh-sys/c/shim/zenoh_shim.c` | Add `zenoh_shim_init_with_config()`                                                                                                                |
| `packages/transport/nano-ros-transport-zenoh-sys/c/shim/zenoh_shim.h` | Declare new types and function                                                                                                                     |
| `packages/transport/nano-ros-transport-zenoh/src/lib.rs`              | FFI binding for new init function                                                                                                                  |
