...
The Embassy example cannot use the full nano-ros executor because nano-ros-transport-zenoh-sys requires a C cross-compilation toolchain visible to `bindgen` at build time.
