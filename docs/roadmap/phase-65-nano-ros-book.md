...
- [ ] 65.7 — Concepts: architecture (move `design/architecture-overview.md`)
- [ ] 65.8 — Concepts: no_std (move `reference/std-alloc-requirements.md`)
- [ ] 65.9 — Concepts: RMW backends (write, draw from `reference/xrce-dds-analysis.md`)
- [ ] 65.10 — Concepts: platform model (write)
- [ ] 65.11 — Guides: message generation (move `guides/message-generation.md`)
- [ ] 65.12 — Guides: creating examples (move `guides/creating-examples.md`)
- [ ] 65.13 — Guides: QEMU bare-metal (move `guides/qemu-bare-metal.md`)
- [ ] 65.14 — Guides: ESP32 (move `guides/esp32-setup.md`)
- [ ] 65.15 — Guides: troubleshooting (move `guides/troubleshooting.md`)
- [ ] 65.16 — Platforms: overview (write)
- [ ] 65.17 — Platforms: POSIX (write)
- [ ] 65.18 — Platforms: Zephyr (move `guides/zephyr-setup.md`)
- [ ] 65.19 — Platforms: FreeRTOS (move `guides/freertos-lan9118-debugging.md`)
- [ ] 65.20 — Platforms: NuttX (write)
- [ ] 65.21 — Platforms: ThreadX (write)
- [ ] 65.22 — Reference: Rust API (write)
- [ ] 65.23 — Reference: C API (move `reference/c-api-cmake.md`)
- [ ] 65.24 — Reference: environment variables (move `reference/environment-variables.md`)
- [ ] 65.25 — Reference: embedded tuning (move `guides/embedded-tuning.md`)
- [ ] 65.26 — Reference: build commands (move `guides/quick-reference.md`)
- [ ] 65.27 — Reference: RMW Zenoh protocol (move `reference/rmw_zenoh_interop.md`)
- [ ] 65.28 — Advanced: verification (move `guides/verus-verification.md`)
- [ ] 65.29 — Advanced: real-time analysis (move `guides/realtime-lint-guide.md` + merge `reference/wcet-baselines.md`)
- [ ] 65.30 — Advanced: safety (move `design/e2e-safety-protocol-integration.md`)
- [ ] 65.31 — Advanced: contributing (write)
- [ ] 65.32 — Delete superseded docs (`guides/getting-started.md`, `reference/micro-ros-comparison.md`)
