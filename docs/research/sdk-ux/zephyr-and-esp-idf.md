...
12. **Single per-example `README.md` template generated by `cargo nano-ros new`.**
    *Problem:* Some examples have READMEs (`examples/zephyr/rust/talker/README.md`), most don't. New users opening `examples/qemu-arm-nuttx/c/talker/` see no guidance.
