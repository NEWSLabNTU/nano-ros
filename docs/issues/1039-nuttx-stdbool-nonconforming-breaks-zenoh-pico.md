...
This is the SECOND defect unmasked in this module today. Issue 0999's preflight
fix (on main as `c003ae608`) stopped `nros build` refusing NuttX at stage 3 for
a build-std target; the build then reaches the compiler and finds this. The
