...
**#361** — Grandfathered committed SystemModels. Surfaced as c/mixed embedded entries codegen-failing
...
embedded-build verification → larger than a config tweak. See `0361-*`. (2026-07-31)
See `0354-*`. (2026-07-31)
