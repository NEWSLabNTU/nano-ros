...
| 58 | Zephyr C++ examples fail — `<initializer_list>` needs full libcpp (regression from 242.3) | bug | c-api | [0058-zephyr-cpp-examples-initializer-list-libcpp.md](0058-zephyr-cpp-examples-initializer-list-libcpp.md) |
