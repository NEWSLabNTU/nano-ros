...
type: bug
area: build
related: [issue-0464, issue-0468, phase-341, rfc-0054]
resolved_in: "phase-341 W3"
---
...
phase-341 W3 emptied `nros`'s `default`, which removed the accidental safety net
...
real dep-site disables". phase-341 W4's `check-feature-contract` should assert
