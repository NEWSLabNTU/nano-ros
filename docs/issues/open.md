...
- **#0917** (rmw, platform) — A fragmented sample either syncs at once or never arrives — 8 RTPS fragments reach the reader in 2 runs of 6, and a failed run never recovers See `0917-*`.
