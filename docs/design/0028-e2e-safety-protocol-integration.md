---
rfc: 0028
title: "E2E Safety Protocol Integration Analysis"
status: Stable
since: 2026-02
...
- `ShimSubscriber`: add `SafetyValidator` field, add `take_validated()` method
...
- Existing `take()` API — remains available, unchanged behavior
