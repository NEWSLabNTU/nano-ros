...
| 0038 | [zero-copy-data-transport](0038-zero-copy-data-transport.md) | Draft | single-copy receive: shared slot pool (runtime QoS depth) + in-place dispatch; removes copy #1 + arena buffer (issue #8) |
