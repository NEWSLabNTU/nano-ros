 ...
 */
void qemu_riscv64_threadx_service_client_cyclonedds_link_anchor(void) {}
...
extern void register_example_interfaces_AddTwoInts_0(void);
extern void register_example_interfaces_AddTwoInts_1(void);

void nros_rmw_cyclonedds_register_app_descriptors(void) {
    register_example_interfaces_AddTwoInts_0();
    register_example_interfaces_AddTwoInts_1();
}
