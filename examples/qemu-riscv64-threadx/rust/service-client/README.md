# `service-client` — qemu-riscv64-threadx / rust
...
```bash
cp -r examples/qemu-riscv64-threadx/rust/service-client ~/my-service-client && cd ~/my-service-client
