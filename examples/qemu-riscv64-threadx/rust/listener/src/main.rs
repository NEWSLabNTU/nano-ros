//! ThreadX QEMU RISC-V Listener — app-node entry (Phase 245).
//!
...
//! `nros::node!(Listener)`). The board owns executor open + RMW + spin; the deploy
//! overlay threads the locator/domain. The CycloneDDS/CMake path uses
