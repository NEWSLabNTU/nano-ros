/// @file main.c
/// @brief ThreadX RISC-V QEMU C action server — Fibonacci on /fibonacci
...
static void accepted_callback(nros_action_server_t *server,
                              const nros_goal_handle_t *goal,
                              void *context) {
...
int nros_app_main(int argc, char **argv) {
    ...
    printf("nros C Action Server (ThreadX RISC-V QEMU)\n");
