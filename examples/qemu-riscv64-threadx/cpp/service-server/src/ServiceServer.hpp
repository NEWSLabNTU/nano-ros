// QEMU RISC-V ThreadX C++ AddTwoInts service server — typed component (RFC-0043).
...
#ifndef RISCV64_THREADX_CPP_SERVICE_SERVER_SERVICESERVER_HPP
#define RISCV64_THREADX_CPP_SERVICE_SERVER_SERVICESERVER_HPP
...
namespace riscv64_threadx_cpp_service_server {
