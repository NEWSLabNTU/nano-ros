// QEMU RISC-V ThreadX C++ Fibonacci action server — typed component (RFC-0043).
...
#ifndef RISCV64_THREADX_CPP_ACTION_SERVER_ACTIONSERVER_HPP
#define RISCV64_THREADX_CPP_ACTION_SERVER_ACTIONSERVER_HPP
...
namespace riscv64_threadx_cpp_action_server {
