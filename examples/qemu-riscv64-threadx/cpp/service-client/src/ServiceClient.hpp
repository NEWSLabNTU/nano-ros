// QEMU RISC-V ThreadX C++ AddTwoInts service client — typed poll component (RFC-0043).
...
#ifndef RISCV64_THREADX_CPP_SERVICE_CLIENT_SERVICECLIENT_HPP
#define RISCV64_THREADX_CPP_SERVICE_CLIENT_SERVICECLIENT_HPP
