...
```bash
cp -r examples/qemu-riscv-nuttx/c/talker ~/my-talker && cd ~/my-talker
...
QEMU / flashing steps live in the [qemu-riscv-nuttx README](https://github.com/NEWSLabNTU/nano-ros/blob/main/examples/qemu-riscv-nuttx/README.md).
