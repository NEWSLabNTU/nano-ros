...
/// @brief Zephyr C Fibonacci action server — typed component (RFC-0043 / phase-244.C2).
///
...
/// handler decodes the CDR goal (int32 order), computes the sequence, and
...
static void on_tick(void* ctx) {
    ...
    printf("Goal completed: %d terms (rc=%d)\n", (int)n, (int)rc);
}
