//! nros Zephyr DDS Action Client Example (Rust)
//!
//! ROS 2 / DDS-RTPS action client running on Zephyr RTOS via dust-dds.
...
extern "C" fn rust_main() {
    ...
    info!("nros Zephyr DDS Action Client");
