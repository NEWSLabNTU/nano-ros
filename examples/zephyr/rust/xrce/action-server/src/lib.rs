//! nros Zephyr XRCE Action Server Example (Rust)
//!
//! A ROS 2 compatible action server running on Zephyr RTOS using the
//! XRCE-DDS backend. The server implements the Fibonacci action —
//! computing Fibonacci sequences with progress feedback.
