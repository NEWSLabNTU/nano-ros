# `action-server` — mps2-an385-freertos / rust
...
```bash
cp -r examples/mps2-an385-freertos/rust/action-server ~/my-action-server && cd ~/my-action-server
...
`build/mps2-an385-freertos/target/<triple>/debug/action-server`
