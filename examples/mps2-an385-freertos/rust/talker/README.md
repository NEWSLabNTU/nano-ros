# `talker` — mps2-an385-freertos / rust
...
```bash
cp -r examples/mps2-an385-freertos/rust/talker ~/my-talker && cd ~/my-talker
...
`build/mps2-an385-freertos/target/<triple>/debug/talker`
