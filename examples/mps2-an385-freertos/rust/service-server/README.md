# `service-server` — mps2-an385-freertos / rust
...
```bash
cp -r examples/mps2-an385-freertos/rust/service-server ~/my-service-server && cd ~/my-service-server
...
`build/mps2-an385-freertos/target/<triple>/debug/service-server`
