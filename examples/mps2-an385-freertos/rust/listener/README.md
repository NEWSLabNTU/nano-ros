# `listener` — mps2-an385-freertos / rust
...
```bash
cp -r examples/mps2-an385-freertos/rust/listener ~/my-listener && cd ~/my-listener
...
`build/mps2-an385-freertos/target/<triple>/debug/listener`
