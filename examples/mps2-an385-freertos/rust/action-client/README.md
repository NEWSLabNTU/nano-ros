# `action-client` — mps2-an385-freertos / rust
...
```bash
cp -r examples/mps2-an385-freertos/rust/action-client ~/my-action-client && cd ~/my-action-client
...
`build/mps2-an385-freertos/target/<triple>/debug/action-client`
