...
The Rust workspace currently ships one native entry. Additional platform
entries should be added as sibling packages, for example
`src/freertos_entry/` or `src/zephyr_entry/`, while reusing the same Node and
Bringup packages.
