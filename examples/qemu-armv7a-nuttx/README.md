# examples/qemu-armv7a-nuttx — NuttX on QEMU (Cortex-M3)
...
just setup nuttx              # = nros setup qemu-armv7a-nuttx + host deps + apps staging
```
...
[`examples/rv-virt-nuttx/`](../rv-virt-nuttx/), not here.
