/// @file main.c
/// @brief ThreadX Linux C action client — sends Fibonacci goal to /fibonacci
...
int nros_app_main(int argc, char **argv) {
    ...
    printf("nros C Action Client (ThreadX Linux)\n");
    ...
    if (!locator) {
        locator = "tcp/127.0.0.1:7575"; /* fixture default — threadx-linux action port */
    }
    uint8_t domain_id = 0;
