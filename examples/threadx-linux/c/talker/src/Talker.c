/// @file Talker.c
/// @brief ThreadX-Linux C talker — typed component (RFC-0043, phase-246).
///
...
/// `Publisher<Int32>` registers, so a typed or raw subscriber matches. No
/// manual support/executor init, no spin loop — the carrier owns the runtime.
