// ThreadX-Linux C++ Fibonacci action client — typed CALLBACK component (RFC-0041/0043).
...
#ifndef THREADX_LINUX_CPP_ACTION_CLIENT_ACTIONCLIENT_HPP
#define THREADX_LINUX_CPP_ACTION_CLIENT_ACTIONCLIENT_HPP
