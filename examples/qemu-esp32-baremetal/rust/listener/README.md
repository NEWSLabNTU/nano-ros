# `listener` — qemu-esp32-baremetal / rust
...
```bash
cp -r examples/qemu-esp32-baremetal/rust/listener ~/my-listener && cd ~/my-listener
...
QEMU / flashing steps live in the [qemu-esp32-baremetal README](https://github.com/NEWSLabNTU/nano-ros/blob/main/examples/qemu-esp32-baremetal/README.md).
