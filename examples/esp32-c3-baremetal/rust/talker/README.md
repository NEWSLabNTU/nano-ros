# `talker` — esp32-c3-baremetal / rust
...
```bash
cp -r examples/esp32-c3-baremetal/rust/talker ~/my-talker && cd ~/my-talker
...
`build/esp32-c3-baremetal/target/<triple>/debug/esp32_qemu_talker`
