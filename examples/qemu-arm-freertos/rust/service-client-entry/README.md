# `service-client-entry` — qemu-arm-freertos / rust
...
```bash
cp -r examples/qemu-arm-freertos/rust/service-client-entry ~/my-service-client-entry && cd ~/my-service-client-entry
