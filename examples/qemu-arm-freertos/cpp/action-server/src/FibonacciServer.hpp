// FreeRTOS C++ Fibonacci action server — typed component (RFC-0043, phase-240.5).
//
...
#ifndef FREERTOS_CPP_ACTION_SERVER_FIBONACCISERVER_HPP
#define FREERTOS_CPP_ACTION_SERVER_FIBONACCISERVER_HPP
