// FreeRTOS C++ AddTwoInts service server — typed component (RFC-0043, phase-240.5).
//
...
#ifndef FREERTOS_CPP_SERVICE_SERVER_ADDTWOINTSSERVER_HPP
#define FREERTOS_CPP_SERVICE_SERVER_ADDTWOINTSSERVER_HPP
