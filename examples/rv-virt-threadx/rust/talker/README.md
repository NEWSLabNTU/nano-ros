...
```bash
cp -r examples/rv-virt-threadx/rust/talker ~/my-talker && cd ~/my-talker
...
`build/rv-virt-threadx/target/<triple>/debug/rv-virt-threadx-talker`
