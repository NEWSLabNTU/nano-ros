# `service-client` — rv-virt-threadx / rust
...
```bash
cp -r examples/rv-virt-threadx/rust/service-client ~/my-service-client && cd ~/my-service-client
...
`build/rv-virt-threadx/target/<triple>/debug/rv-virt-threadx-service-client`
