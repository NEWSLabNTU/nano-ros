# `listener` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/listener ~/my-listener && cd ~/my-listener
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-bsp-listener`
