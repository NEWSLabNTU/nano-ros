# `talker` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/talker ~/my-talker && cd ~/my-talker
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-bsp-talker`
