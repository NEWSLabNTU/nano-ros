# `talker-rtic-mixed` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/talker-rtic-mixed ~/my-talker-rtic-mixed && cd ~/my-talker-rtic-mixed
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-rtic-mixed-talker`
