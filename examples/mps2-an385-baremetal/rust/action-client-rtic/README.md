# `action-client-rtic` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/action-client-rtic ~/my-action-client-rtic && cd ~/my-action-client-rtic
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-rtic-action-client`
