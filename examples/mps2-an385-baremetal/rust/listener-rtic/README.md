# `listener-rtic` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/listener-rtic ~/my-listener-rtic && cd ~/my-listener-rtic
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-rtic-listener`
