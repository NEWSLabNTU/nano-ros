# `talker-rtic` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/talker-rtic ~/my-talker-rtic && cd ~/my-talker-rtic
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-rtic-talker`
