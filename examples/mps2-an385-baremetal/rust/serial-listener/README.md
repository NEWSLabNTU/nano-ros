# `serial-listener` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/serial-listener ~/my-serial-listener && cd ~/my-serial-listener
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-serial-listener`
