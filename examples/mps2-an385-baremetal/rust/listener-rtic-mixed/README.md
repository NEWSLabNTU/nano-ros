# `listener-rtic-mixed` — mps2-an385-baremetal / rust
...
```bash
cp -r examples/mps2-an385-baremetal/rust/listener-rtic-mixed ~/my-listener-rtic-mixed && cd ~/my-listener-rtic-mixed
...
`build/mps2-an385-baremetal/target/<triple>/debug/qemu-rtic-mixed-listener`
