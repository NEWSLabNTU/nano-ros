//! Hardware timer clock for ESP32
//!
//! Uses `esp_hal::time::Instant` for monotonic timestamps.
//! Unlike the QEMU BSP, no software counter is needed - the hardware timer
//! is authoritative.
...
/// Set current time in milliseconds (no-op on ESP32 - hardware timer is authoritative)
#[unsafe(no_mangle)]
