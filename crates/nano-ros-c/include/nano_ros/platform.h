/**
 * nano-ros platform abstraction layer
 *
 * This header provides compile-time platform selection for nano-ros.
 * Users must define one of the platform macros before including nano-ros headers.
 *
 * Supported platforms:
