...
//! `ros2 param` CLI tools to interact with nano-ros nodes.
//!
//! # Services
//!
...
pub fn to_rcl_descriptor(desc: &InternalDescriptor) -> ParameterDescriptor {
    ...
    match &desc.range {
        nano_ros_params::ParameterRange::None => {}
        nano_ros_params::ParameterRange::Integer(range) => {
            let ir = IntegerRange {
        ...
        nano_ros_params::ParameterRange::FloatingPoint(range) => {
