...
#
# Defaults to packages/testing/nros-bench/wcet-cycles-qemu if no example-dir given.
...
while [[ $# -gt 0 ]]; do
    case "$1" in
        ...
        -h|--help)
            ...
            echo "                (default: packages/testing/nros-bench/wcet-cycles-qemu)"
...
# =============================================================================
    ...
    EXAMPLE_DIR="${EXAMPLE_DIR:-packages/testing/nros-bench/wcet-cycles-qemu}"
    if [[ "$EXAMPLE_DIR" != /* ]]; then
