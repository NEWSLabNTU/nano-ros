...
| 93 | C and C++ Doxygen completion (C++ mainpage, `@defgroup` taxonomy, per-function `@param`/`@return`, template-concept docs, error-code reference) | In Progress (A, B, E1+E3, F1+F3, G done; C, D, E2, F2 remaining) |
