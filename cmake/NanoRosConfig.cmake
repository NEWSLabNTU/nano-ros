...
function(nano_ros_read_config CONFIG_FILE)
    ...
    foreach(_line IN LISTS _lines)
        ...
        if("${_line}" MATCHES "^([a-z_]+)[ \t]*=[ \t]*(.*)")
            ...
            # [node] section (Phase 172.K — direct-mode nros.toml)
            elseif("${_section}" STREQUAL "node")
            ...
            # [scheduling] / [node.rt] section
            elseif("${_section}" STREQUAL "scheduling" OR "${_section}" STREQUAL "node.rt")
