...
function(rclcpp_components_register_node component_target)
    ...
    # Generated entry point. The component class is expected to take a
    # `rclcpp::NodeOptions` (stock ROS 2 signature) — that's currently outside
    # 209.A's surface; the entry point uses the `(const std::string&)` ctor
    # shape the rclcpp_compat.hpp Node shim exposes. Real `NodeOptions`
    # construction is Phase 209.F (params).
    file(GENERATE OUTPUT "${_gen_src}" CONTENT
        ...
        "    auto node = std::make_shared<${_RCRN_PLUGIN}>();\n"
